...
<div class="wrapper bgded" style="background-image:url('/images/demo/backgrounds/тип2.jpg');">
    <div id="pageintro" class="hoc clear">
        <!-- ################################################################################################ -->
        <article>
            <div class="overlay inspace-30 btmspace-30">
                <h2 class="heading">Фриланс</h2>
                <p> это механизм, суть которого заключается в том, что некая особа
                    или фирма нанимает себе на выполнение определенной задачи человека,
                    не зачисляя его в штат фирмы.</p>
            </div>
            <footer>
                <ul class="nospace inline pushright">
                    <li><a class="btn" href="#">Каталог заданий</a></li>
                    <li><a class="btn inverse" href="#">Фрилансеры</a></li>
                </ul>
            </footer>
        </article>
        <!-- ################################################################################################ -->
...
<div class="wrapper row3">
    <section class="hoc container clear">
        ...
        <div class="center btmspace-50">
            <h2 class="heading">Пермиум задания</h2>
        </div>
...
<div class="wrapper row3">
    <main class="hoc container clear">
        ...
        <!-- ################################################################################################ -->
        <div class="center btmspace-50">
            <h2 class="heading">Новые задания</h2>
        </div>
...
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
<div class="wrapper bgded overlay" style="background-image:url('/images/demo/backgrounds/96584a16c23eb56570c4a7f7ef1818fc.jpg');">
...
<div class="wrapper row3">
    <main class="hoc container clear">
        ...
        <!-- ################################################################################################ -->
        <div class="center btmspace-50">
            <h2 class="heading">Новые вакансии</h2>
        </div>
        <article class="one_third first btmspace-50">
            <h3 class="font-x1 btmspace-30"><i class="fa fa-2x fa-500px rightspace-10"></i> <a href="#">Aliquam in lacus</a></h3>
            <p>Bibendum et vestibulum condimentum rutrum arcu sed posuere sem in eu lectus sit amet dolor ultrices suscipit aliquam vestibulum sollicitudin dapibus&hellip;</p>
